    ...
    public static class LocalServer
    {
        ...
        public static async Task<string> StartServerAsync(string prefix)
        {
            ...
            while (true)
            {
                ...
                var message = "Authentication complete. You can now close this window and return to the CLI. <a href='/cli-logout'>Logout and try again</a>.  <a href='https://aicapture.io/'>AI Capture Home</a> <br />(<a href='https://localhost:7033/'>Localhost Home</a>).";
